...
\`\`\``;
    ...
    try {
      ...
      // Si no se pudo extraer el resultado, crear una respuesta de fallback
        if (!resultado.resumen && (!resultado.detalle_movimientos || !Array.isArray(resultado.detalle_movimientos))) {
        ...
        resultado = {
            resumen: {
              total_procesados: resultado.resumen?.total_procesados || 0,
              total_conciliados: resultado.resumen?.total_conciliados || 0,
              total_no_conciliados: resultado.resumen?.total_no_conciliados || 0
            },
